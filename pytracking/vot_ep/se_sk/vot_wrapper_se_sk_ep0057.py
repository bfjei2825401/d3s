...
from pytracking.tracker.segm_se_sk import SegmSESK
from pytracking.parameter.segm_se_sk import default_params_ep as vot_params
...
params = vot_params.parameters(57)
