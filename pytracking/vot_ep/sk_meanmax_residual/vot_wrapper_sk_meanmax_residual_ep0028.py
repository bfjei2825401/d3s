...
from pytracking.tracker.segm_sk_meanmax_residual import SegmSKMeanMaxResidual
from pytracking.parameter.segm_sk_meanmax_residual import default_params_ep as vot_params
...
params = vot_params.parameters(28)
...
tracker = SegmSKMeanMaxResidual(params)
