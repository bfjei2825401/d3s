...
from pytracking.tracker.segm_sk_meanmax_only import SegmSKMeanMaxOnly
from pytracking.parameter.segm_sk_meanmax_only import default_params_ep as vot_params
...
tracker = SegmSKMeanMaxOnly(params)
