...
from pytracking.tracker.segm_sk import SegmSK
from pytracking.parameter.segm_sk import finetune_params_ep as vot_params
...
params = vot_params.parameters(11)
