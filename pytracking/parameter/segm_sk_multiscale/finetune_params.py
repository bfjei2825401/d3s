...
def parameters():
    ...
    params.segm_net_path = '/home/slz/GitHub/d3s/save/checkpoints/ltr/segm_sk_multiscale/segm_sk_multiscale_finetune/SegmNet_ep0020.pth.tar'
    params.constructor_module = 'ltr.models.segm_sk_multiscale.segm_sk_multiscale'
    params.constructor_fun_name = 'segm_sk_multiscale_resnet50'
