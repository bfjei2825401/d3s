...
def parameters():
    ...
    params.segm_net_path = '/home/slz/GitHub/d3s/save/checkpoints/ltr/segm_backbone_sk/segm_backbone_sk_default/SegmNet_ep0040.pth.tar'
    params.constructor_module = 'ltr.models.segm_backbone_sk.segm_backbone_sk'
    params.constructor_fun_name = 'segm_backbone_sk_resnet50'
