...
def parameters():
    ...
    params.segm_net_path = '/home/slz/GitHub/d3s/save/checkpoints/ltr/segm_sk_meanmax/segm_sk_meanmax_finetune/SegmNet_ep0020.pth.tar'
    params.constructor_module = 'ltr.models.segm_sk_meanmax.segm_sk_meanmax'
    params.constructor_fun_name = 'segm_sk_meanmax_resnet50'
