...
def parameters():
    ...
    params.segm_net_path = '/home/slz/GitHub/d3s/save/checkpoints/ltr/segm_sk/segm_sk_finetune/SegmNet_ep0020.pth.tar'
    params.constructor_module = 'ltr.models.segm_sk.segm_sk'
    params.constructor_fun_name = 'segm_sk_resnet50'
