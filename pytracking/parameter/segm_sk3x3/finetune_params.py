...
def parameters():
    ...
    params.segm_net_path = '/home/slz/GitHub/d3s/save/checkpoints/ltr/segm_sk3x3/segm_sk3x3_finetune/SegmNet_ep0020.pth.tar'
    params.constructor_module = 'ltr.models.segm_sk3x3.segm_sk3x3'
    params.constructor_fun_name = 'segm_sk3x3_resnet50'
