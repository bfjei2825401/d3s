...
def parameters():
    ...
    params.segm_net_path = '/home/slz/GitHub/d3s/save/checkpoints/ltr/segm_sk_meanmax_residual/segm_sk_meanmax_residual_default/SegmNet_ep0040.pth.tar'
    params.constructor_module = 'ltr.models.segm_sk_meanmax_residual.segm_sk_meanmax_residual'
    params.constructor_fun_name = 'segm_sk_meanmax_residual_resnet50'
