...
def parameters():
    ...
    params.segm_net_path = '/home/slz/GitHub/d3s/save/checkpoints/ltr/segm_sk_max/segm_sk_max_default/SegmNet_ep0040.pth.tar'
    params.constructor_module = 'ltr.models.segm_sk_max.segm_sk_max'
    params.constructor_fun_name = 'segm_sk_max_resnet50'
