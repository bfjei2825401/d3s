...
def parameters():
    ...
    params.augmentation = {'fliplr': True,
                           ...
                           'relativeshift': [(0.25, 0.25), (-0.25, 0.25), (0.25, -0.25), (-0.25, -0.25), (0.75, 0.75),
    ...
    params.segm_net_path = '/home/slz/GitHub/d3s/save/checkpoints/ltr/segm_sk3x3_meanmax_adaptive/segm_sk3x3_meanmax_adaptive_default/SegmNet_ep0040.pth.tar'
    params.constructor_module = 'ltr.models.segm_sk3x3_meanmax_adaptive.segm_sk3x3_meanmax_adaptive'
    params.constructor_fun_name = 'segm_sk3x3_meanmax_adaptive_resnet50'
