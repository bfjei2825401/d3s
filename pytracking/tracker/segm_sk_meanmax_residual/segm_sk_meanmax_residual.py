...
class SegmSKMeanMaxResidual(BaseTracker):
    ...
    def init_segmentation(self, image, bb, init_mask=None):
        ...
        segm_net, _ = load_network(self.params.segm_net_path, backbone_pretrained=False,
                                   constructor_module='ltr.models.segm_sk_meanmax_residual.segm_sk_meanmax_residual',
                                   constructor_fun_name='segm_sk_meanmax_residual_resnet50')
