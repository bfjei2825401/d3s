...
from ltr.models.layers.sk_block import SKConv3x3
from ltr.models.layers.common_block import conv, conv_no_relu


class SegmNetSK3x3(nn.Module):
    ...
    def __init__(self, segm_input_dim=(128, 256), segm_inter_dim=(256, 256), segm_dim=(64, 64), mixer_channels=2,
        ...
        self.sk2 = SKConv3x3(segm_inter_dim[2])
        self.sk1 = SKConv3x3(segm_inter_dim[1])
        self.sk0 = SKConv3x3(segm_inter_dim[0])
