...
import ltr.models.segm_sk_multiscale as models
from ltr import model_constructor
from ltr.models.segm.segm import SegmNet


@model_constructor
def segm_sk_multiscale_resnet18(segm_input_dim=(256, 256), segm_inter_dim=(256, 256), backbone_pretrained=True,
                                topk_pos=3,
    ...
    # segmentation
    segm_predictor = models.SegmNetSKMultiscale(segm_input_dim=segm_input_dim,
...
@model_constructor
def segm_sk_multiscale_resnet50(segm_input_dim=(256, 256), segm_inter_dim=(256, 256), backbone_pretrained=True,
                                topk_pos=3,
                                topk_neg=3, mixer_channels=2):
    # backbone
