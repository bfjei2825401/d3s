...
from ltr.models.layers.sk_block import SKConvMax
from ltr.models.layers.common_block import conv, conv_no_relu


class SegmNetSKMax(nn.Module):
    ...
    def __init__(self, segm_input_dim=(128, 256), segm_inter_dim=(256, 256), segm_dim=(64, 64), mixer_channels=2,
        ...
        self.sk2 = SKConvMax(segm_inter_dim[2])
        self.sk1 = SKConvMax(segm_inter_dim[1])
        self.sk0 = SKConvMax(segm_inter_dim[0])
