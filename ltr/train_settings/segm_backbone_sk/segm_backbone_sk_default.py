...
import ltr.models.segm_backbone_sk.segm_backbone_sk as models
...
def run(settings):
    ...
    net = models.segm_backbone_sk_resnet50(backbone_pretrained=True, topk_pos=settings.segm_topk_pos,
