...
import ltr.models.segm_sk_meanmax_residual.segm_sk_meanmax_residual as models
...
def run(settings):
    ...
    net = models.segm_sk_meanmax_residual_resnet50(backbone_pretrained=True, topk_pos=settings.segm_topk_pos,
