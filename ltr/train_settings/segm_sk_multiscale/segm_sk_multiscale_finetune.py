...
import ltr.models.segm_sk_multiscale.segm_sk_multiscale as models
...
def run(settings):
    ...
    net = models.segm_sk_multiscale_resnet50(backbone_pretrained=True, topk_pos=settings.segm_topk_pos,
