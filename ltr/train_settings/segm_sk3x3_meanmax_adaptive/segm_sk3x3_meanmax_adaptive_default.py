...
import ltr.models.segm_sk3x3_meanmax_adaptive.segm_sk3x3_meanmax_adaptive as models
...
def run(settings):
    ...
    net = models.segm_sk3x3_meanmax_adaptive_resnet50(backbone_pretrained=True, topk_pos=settings.segm_topk_pos,
