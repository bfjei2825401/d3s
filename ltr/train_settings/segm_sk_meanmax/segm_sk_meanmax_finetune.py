...
import ltr.models.segm_sk_meanmax.segm_sk_meanmax as models
...
def run(settings):
    ...
    net = models.segm_sk_meanmax_resnet50(backbone_pretrained=True, topk_pos=settings.segm_topk_pos,
